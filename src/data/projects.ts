...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    role: "Architectural consultant — exhibition design",
    description:
      "A 14,500m² pavilion for the UAE at Expo 2020 Dubai, delivered at a US$500M construction value. The role bridged the base-build architecture by Santiago Calatrava with the exhibition design by Kossmann.dejong, resolving structural, fire, circulation, and legacy-design conflicts through the developed and detailed design stages. On-site in Dubai for construction administration, working alongside BIM contractors to protect design intent and offer alternative resolutions where compromise was unavoidable.",
    hero: PH_HERO,
    gallery: PH_GALLERY,
  },
  {
